...
class MultiModalDataLoader:
    ...
    def __init__(self) -> None:
        ...
        self.parse_data(text_bart_embeddings, video_features_file, audio_features, context_bart_embeddings, audio_context_features)
    ...
    def parse_data(self, text: List[np.ndarray], video: File, audio: list[np.ndarray], text_c: List[list], audio_c: list[np.ndarray]) -> None:
        """
